...
const Home = () => {
  ...
  return (
    <div className="flex flex-col gap-4 bg-slate-100 dark:bg-slate-900 py-4 px-4 senone">
      ...
      <div className="w-full h-[calc(100vh-6rem)] grid grid-cols-2 grid-rows-5 gap-x-6 gap-y-4">
        ...
        <div className="bg-item row-span-4 rounded-bl-3xl flex-col gap-8">
          <p className="h5">قد</p>
        ...
        <div className="bg-item row-span-2 rounded-br-3xl flex flex-col">
          ...
          <div className="flex-1 flex flex-row gap-6 items-center justify-center">
            <button className="bg-slate-300 dark:bg-slate-900 p-4 rounded-full hover:bg-slate-200 dark:hover:bg-slate-700">
              <FaPlus />
            </button>
            <button className="bg-slate-300 dark:bg-slate-900 p-4 rounded-full hover:bg-slate-200 dark:hover:bg-slate-700">
              <FaMinus />
